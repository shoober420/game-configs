rem # PERFORMANCE
start steam://rungameid/730 -vulkan -width 1600 -height 1200 -w 1600 -h 1200 -refresh 120 -refreshrate 120 -freq 120 -frequency 120 -clientport 65007 -console -forcenovsync -full -fullscreen -limitvsconst -softparticlesdefaultoff -precachefontchars -noff -noforcemaccel -noforcemspd -nohltv -nojoy -nosteamcontroller -novid -preload -nodns -no-browser -noaafonts -nomsaa -noipx +mat_queue_mode 2 +mat_disable_fancy_blending 1 +engine_low_latency_sleep_after_client_tick 1 +r_dynamic 0 +exec autoexec.cfg
...
rem # HIGH QUALITY
rem start steam://rungameid/730 -vulkan -w 1600 -h 1200 -refresh 120 -refreshrate 120 -freq 120 -clientport 65007 -console -forcenovsync -fullscreen -precachefontchars -noff -noforcemaccel -noforcemspd -nohltv -nojoy -nosteamcontroller -novid -preload -nodns -no-browser -noipx +mat_queue_mode 2 +exec autoexec.cfg
