rem # PERFORMANCE
start steam://rungameid/550 -lv -vulkan -width 3840 -height 2160 -w 3840 -h 2160 -full -fullscreen +mat_motion_blur_percent_of_screen_max 0 -softparticlesdefaultoff -limitvsconst -precachefontchars -clientport 65007 -console -forcenovsync -noff -noforcemaccel -noforcemspd -nohltv -nojoy -nosteamcontroller -novid -preload -refresh 240 -refreshrate 240 -freq 240 -frequency 240 -tickrate 128 -nodns -noipx -no-browser -noaafonts -nomsaa +mat_queue_mode 2 -nomessagebox -nocrashdialog -nostartupsound +exec autoexec.cfg
